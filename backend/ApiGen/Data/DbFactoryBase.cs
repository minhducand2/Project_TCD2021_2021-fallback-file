...
namespace ApiGen.Data
{
    public abstract class DbFactoryBase
    {
        ...
        internal string DbMySQLConnectionString => _config.GetConnectionString("MySQLConnectionString");
        internal string DbPostgresConnectionString => _config.GetConnectionString("PostgreSQLConnectionString");
        ...
        internal IDbConnection DbMysqlConnection => new MySql.Data.MySqlClient.MySqlConnection(DbMySQLConnectionString);
        internal IDbConnection DbPostgresConnection => new NpgsqlConnection(DbPostgresConnectionString);
