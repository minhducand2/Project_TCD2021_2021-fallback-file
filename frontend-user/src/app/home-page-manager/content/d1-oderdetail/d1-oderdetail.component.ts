...
@Component({
  selector: 'app-d1-oderdetail',
  templateUrl: './d1-oderdetail.component.html',
  styleUrls: ['./d1-oderdetail.component.scss']
})
export class D1OderDetailComponent implements OnInit,OnDestroy {
