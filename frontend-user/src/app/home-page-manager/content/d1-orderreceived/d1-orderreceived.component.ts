...
@Component({
  selector: 'app-d1-orderreceived',
  templateUrl: './d1-orderreceived.component.html',
  styleUrls: ['./d1-orderreceived.component.scss']
})
export class D1OrderreceivedComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  getLoadDataUserOder() {
    ...
    this.subscription.push(
      this.api.excuteAllByWhat(param, '2819').subscribe((result) => {
        let stt = 1;
        if (result.length > 0) {
...
*/
   ...
   */
  onViewsClick(id) {
    const url = '/manager/admin/d2-order-views/' + id + '/' + '2' + '/orderview';
